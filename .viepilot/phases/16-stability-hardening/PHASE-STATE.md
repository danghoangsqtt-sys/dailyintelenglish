...
|---|---|---|---|---|
| 16.1 | Worker loop guard + `worker_alive` (BUG-022) | Coder | done (pending PM ACCEPTED) | PM diff review + revert check |
| 16.2 | ffmpeg timeouts (ENH-008) | Coder | not started | card design → PM approval |
