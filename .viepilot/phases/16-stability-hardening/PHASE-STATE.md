...
| 16.3 | Test-data leak root cause + guard + cleanup script + CHANGELOG Phase 15 (BUG-023) | Coder → PM | Coder side done (pending PM ACCEPTED) | PM diff review + revert check, then PM runs dry-run → owner → `--apply` |
